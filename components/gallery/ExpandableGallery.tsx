        ...
        {items.map((item, index) => {
          ...
          return (
            <motion.button
              ...
              className={`group relative overflow-hidden rounded-[30px] border border-[#dcebe3] bg-white text-left shadow-[0_18px_40px_rgba(20,40,34,0.06)] transition-all duration-500 hover:border-[#c8ddd2] hover:shadow-[0_26px_56px_rgba(20,40,34,0.10)] ${layoutClass}`}
            >
              ...
              <div className="absolute left-4 top-4 z-10 rounded-full border border-white/20 bg-white/12 px-3 py-2 text-[10px] font-bold uppercase tracking-[0.22em] text-white backdrop-blur-md">
                {item.category}
              </div>

              <div className="absolute right-4 top-4 z-10 flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-white/12 text-white backdrop-blur-md transition-transform duration-300 group-hover:scale-105">
                <svg
                  className="h-5 w-5"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        {activeItem && activeIndex !== null && (
          <>
            <motion.div
              ...
              className="fixed inset-0 z-70 bg-[rgba(8,22,17,0.68)] backdrop-blur-xl"
            ...
            >
              <div className="relative w-full max-w-6xl overflow-hidden rounded-[34px] border border-white/16 bg-[linear-gradient(180deg,rgba(255,255,255,0.10),rgba(255,255,255,0.06))] shadow-[0_40px_120px_rgba(0,0,0,0.28)] backdrop-blur-2xl">
                <button
                  type="button"
                  onClick={() => setActiveIndex(null)}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12">
                  <div className="relative lg:col-span-8">
                    <motion.img
                      ...
                      className="h-80 w-full object-cover sm:h-110 lg:h-180"
                    />

                    <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(8,18,14,0.04),rgba(8,18,14,0.14)_45%,rgba(8,18,14,0.34)_100%)]" />
                  </div>
