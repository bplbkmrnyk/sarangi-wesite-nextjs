...
export default function PageBackground({
  ...
  return (
    <div className={`pointer-events-none absolute inset-0 z-0 ${withSketch ? "overflow-hidden" : ""}`}>
      {/* Base Background */}
      ...
      {withSketch ? (
        <>
          ...
          <div className="absolute inset-0 bg-[rgba(247,236,236,0.62)]" />
        ...
        >
          {/* Faded Grid Pattern */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(var(--accent-soft-rgb),0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(var(--accent-soft-rgb),0.06)_1px,transparent_1px)] bg-[size:100px_100px] opacity-70" />
